...
#define  OSSL2_DEBUG(...)  do { fprintf(stderr,"[%s:%d] <DEBUG> ",__FILE__,__LINE__); fprintf(stderr, __VA_ARGS__); fprintf(stderr,"\n"); fflush(stderr); } while(0)

#define  OSSL2_BUFFER_DEBUG(ptr,size,...)                                                          \
do {                                                                                              \
