#ifndef __DER_INTERN_LOG_H_47D822EB5F5DDD396D70E3833E294350__
#define __DER_INTERN_LOG_H_47D822EB5F5DDD396D70E3833E294350__
...
#define  CMN_OSSL2_DEBUG(...)  do { fprintf(stderr,"[%s:%d] <DEBUG> ",__FILE__,__LINE__); fprintf(stderr, __VA_ARGS__); fprintf(stderr,"\n"); fflush(stderr); } while(0)

#define  CMN_OSSL2_BUFFER_DEBUG(ptr,size,...)                                                          \
do {                                                                                              \
...
#define  CMN_OSSL_DEBUG(...)  do { fprintf(stderr,"[%s:%d] <DEBUG> ",__FILE__,__LINE__); fprintf(stderr, __VA_ARGS__); fprintf(stderr,"\n"); fflush(stderr); } while(0)

#define  CMN_OSSL_BUFFER_DEBUG(ptr,size,...)                                                          \
do {                                                                                              \
	unsigned char* __ptr = (unsigned char*)(ptr);                                                 \
	int __size = (int) (size);                                                                    \
	int __i,__lasti = 0;	                                                                      \
...
#endif /* __DER_INTERN_LOG_H_47D822EB5F5DDD396D70E3833E294350__*/
